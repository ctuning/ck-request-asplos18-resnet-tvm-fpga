...
In order to maximize compute resources utilization, VTA relies on a decoupled access-execute pipeline~\cite{Smith:DAE} where memory load, stores and computation can occur independently, and concurrently.
